...
public class LeidiniaiController {
	...
	@Autowired
	private KalbosRepository kalbosRepository;
	
    @GetMapping("/leidiniai")
    public String leidiniai (@RequestParam(name="name", required=false, defaultValue="World") String name, Model model) {
    	model.addAttribute("kalbos", kalbosRepository.findAll() );
